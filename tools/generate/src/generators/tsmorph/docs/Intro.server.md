...
The supported server frameworks (fastify-openapi-glue, express-openapi-validator) natively
support incoming and outgoing data validation based on your OpenApi specification.
They also provide the needed hooks to implement the security mechanisms defined in your specification.
